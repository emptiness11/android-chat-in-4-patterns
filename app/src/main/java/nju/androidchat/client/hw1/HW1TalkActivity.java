    ...
    public void showMessageList(List<ClientMessage> messages) {
        runOnUiThread(() -> {
                    ...
                    for (ClientMessage message : messages) {
                        ...
                        boolean isImage=isImage(text,imgData);

                        if (message.getSenderUsername().equals(this.presenter.getUsername())) {
                            content.addView(new ItemTextSend(this, text, message.getMessageId(), this,isImage));
                        } else {
                            content.addView(new ItemTextReceive(this, text, message.getMessageId(),isImage));
                        }
                    }
